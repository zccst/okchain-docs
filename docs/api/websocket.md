...
- dex_spot/optimized_depth // depth data, 200 entries for the first time, then incremental
...
of which `dex_spot/matches` is a channel name, `BCOIN-USDT`is a product
